<?php
/**
 * A template file for the surgical category slug.
 *
...
if ($query->have_posts()):
	...
	echo '<div class="page-body' . $bg_color . '">
		...
		// frankie added search 
		// search form source: https://deluxeblogtips.com/search-by-category-wordpress/
		$term = null;
		$btn = __('Search');
	...
	<?php
		...
		$categoryTags = get_category_tags(['categories' => $term->term_id]);
